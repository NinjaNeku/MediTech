...
const HomepageHeading = ({ mobile, doctorList }) => {
  ...
  useEffect(() => {
    axios.get('https://MediTech-backend.vercel.app/doctors')
      .then(response => {
            ...
            >
              <Container>
                ...
                <Menu.Item position='right'>
                  <Button href="mailto:MediTech27@gmail.com" as='a'  inverted={!fixed} primary={fixed} style={{ marginLeft: '0.5em' }}>
                    Contact Us
                  </Button>
                </Menu.Item>
              </Container>
          ...
          >
            <Container>
              <Menu inverted pointing secondary size='large'>
                ...
                <Menu.Item position='right'>
                  <Button href="mailto:MediTech27@gmail.com" as='a' inverted style={{ marginLeft: '0.5em' }}>
                    Contact Us
                  </Button>
                </Menu.Item>
              </Menu>
...
const Homepage = () => {
  ...
  const panels = [
    {
      key: 'what-is-dog',
      title: 'What is MediTech?',
      content: [
        'MediTech is a healthcare platform designed by a small team with a big ambition. It aims to provide ease of access in terms of healthcare.',
      ].join(' '),
    },
    {
      key: 'kinds-of-dogs',
    ...
    {
      key: 'teamcontact',
      title: 'How can I contact MediTech team?',
      content:[
        'Feel free to mail us at MediTech27@gmail.com so we can hear what you have to say!',
      ].join(' '),
    },
  ]
      ...
      <Segment style={{ padding: '8em 0em' }} vertical>
        <Container text>
          ...
          <p style={{ fontSize: '1.33em', textAlign: "center" }}>
            MediTech is a revolutionary platform designed to seamlessly connect patients with healthcare providers,
            ensuring swift and efficient access to medical assistance. Through MediTech,
          ...
          <p style={{ fontSize: '1.33em', textAlign: "center" }}>
            By leveraging cutting-edge technology, MediTech simplifies the healthcare journey, empowering patients to take
            ...
            MediTech is committed to providing a hassle-free experience, making healthcare more accessible and responsive to the needs of every individual.
          </p>
        </Container>
      </Segment>
